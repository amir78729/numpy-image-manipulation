...
# مراحل پروژه
۱ -یک عکس از ناحیه ی مورد نظر خود بگیرید )تصویر خودتان یا یک منظره(

۲ -آن را بصورت ماتریس ذخیره کنید.

۳ -ابرداده های آن را رسم کنید.

۴ -میانگین داده ها را بیابید

۵ -با استفاده از قسمت ۴ ، ماتریس کوواریانس را بسازید.

۶ -مقدار واریانس و همبستگی داده ها را محاسبه و بر اساس مقدار به دست آمده آن را تحلیل کنید.

۷ -داده ای که در حال حاضر با آن کار میکنید 3 بعدی است. آیا بعد آن را میتوان کاهش داد؟ برای این
منظور از روش واریانس کل داده ها استفاده کنید

۸ -با استفاده از روش analyze component principle حداقل یک عکس جدید از ورودی خود
تولید کنید 
